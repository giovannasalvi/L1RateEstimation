...
#fitname = "pol2"
#fitname = "chebyshev2"
fitname = ROOT.TF1("fitname","[0]*x + [2]*x*x",0,80);
#outFile = ROOT.TFile(new.root,"RECREATE");
#fitname.SetParameters(-10,10);

filedir = "/afs/cern.ch/user/g/gsalvi/CMSSW_11_0_2/src/L1MenuTools/rate-estimation/results/fill246_6961_PU.csv"
...
#        key = "Rate: %.2f +- %.2f @PU50, %.2f +- %.2f @PU56, %.2f +- %.2f @PU62" %(f2_2.Eval(50), error_vec.at(50-fit_min), f2_2.Eval(56), error_vec.at(56-fit_min), f2_2.Eval(62), error_vec.at(62-fit_min))
	key = "Rate: %.2f +- %.2f @PU35, %.2f +- %.2f @PU40, %.2f +- %.2f @PU45" %(f2_2.Eval(35), error_vec.at(35-fit_min), f2_2.Eval(40), error_vec.at(40-fit_min), f2_2.Eval(45), error_vec.at(45-fit_min))
...
def DrawL1(key, pattern):
    ...
    if config == 2018:
        l_1 = ROOT.TLine(35, 0, 35, maxy)
        l_1.SetLineColor(2)
        l_1.SetLineWidth(2)
        l_1.Draw()
        l_2 = ROOT.TLine(40, 0, 40, maxy)
        l_2.SetLineColor(2)
        l_2.SetLineWidth(2)
        l_2.Draw()
        l_3 = ROOT.TLine(45, 0, 45, maxy)
        l_3.SetLineColor(2)
        l_3.SetLineWidth(2)
        l_3.Draw()
...
if __name__ == "__main__":
    ...
    c2 = ROOT.TCanvas("fit","fit", 1200, 1000)
